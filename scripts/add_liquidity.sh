...
export AMOUNT_PORK_DESIRED="25000000000000000000000000000"  # 25 billion PORK (25e9 * 1e18 for 18 decimals)
export AMOUNT_WMATIC_DESIRED="10000000000000000000"  # Example: 10 WMATIC (10e18 wei); adjust based on your funding
export AMOUNT_PORK_MIN="20000000000000000000000000000"  # Min PORK to add (e.g., 80% of desired to allow slippage)
